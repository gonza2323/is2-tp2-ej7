import { Box, Button, FileInput, Select, Group, NumberInput, TextInput } from '@mantine/core';
import { paths } from '@/routes';
import { useForm, zodResolver } from '@mantine/form';
import { notifications } from '@mantine/notifications';
import { ArticuloCreateDto } from '@/api/dtos';
  ...
  return (
    <Box component="form" onSubmit={form.onSubmit(handleSubmit)} maw={400}>
      ...
      <Select
        ...
        data={proveedores.map((p) => ({ value: p.id.toString(), label: p.nombre }))}
